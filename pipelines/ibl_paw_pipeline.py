...
pipe_kwargs = {
    ...
    'make_sync_video': {  # create sync video for manual timestamp qc
        'run': False,
        'kwargs': {'overwrite': True, 'use_raw_vids': False, 'idx_beg': 15000, 'idx_end': 15500}},
...
eids = [
    ...
    # '66d98e6e-bcd9-4e78-8fbb-636f7e808b29',  # sync ok (off by a frame or two) [bad lp+ks]
    ...
    # '1ec23a70-b94b-4e9c-a0df-8c2151da3761',  # sync ok (off by a couple frames) [good lp+ks]
    'a7763417-e0d6-4f2a-aa55-e382fd9b5fb8',  # sync good
    # '19e66dc9-bf9f-430b-9d6a-acfa85de6fb7',  # sync BAD (off by a couple frames)
    ...
    # 'e349a2e7-50a3-47ca-bc45-20d1899854ec',  # sync BAD (off by a couple frames) [good lp+ks]
    # '5adab0b7-dfd0-467d-b09d-43cb7ca5d59c',  # sync BAD (off by a couple frames) [eh lp+ks]
    # additional repro sessions
...
eids = [
    '56b57c38-2699-4091-90a8-aba35103155e',  # sync good; in paw labeled data
    '41872d7f-75cb-4445-bb1a-132b354c44f0',  # sync good; not in BWM dataset
    # '6f09ba7e-e3ce-44b0-932b-c003fb44fb89',  # sync BAD (left cam ok) (in litpose pupil list)
    # '862ade13-53cd-4221-a3fa-dda8643641f2',  # sync BAD (left cam bad)
    '72cb5550-43b4-4ef0-add5-e4adfdfb5e02',  # sync ok (off by one) (in litpose paw list)
    'ee40aece-cffd-4edb-a4b6-155f158c666a',  # sync good
    '30c4e2ab-dffc-499d-aae4-e51d6b3218c2',  # sync good; not in BWM dataset
    'c7248e09-8c0d-40f2-9eb4-700a8973d8c8',  # sync ok (off by one?); not in BWM dataset
    'f312aaec-3b6f-44b3-86b4-3a0c119c0438',  # sync good
    'dda5fc59-f09a-4256-9fb5-66c67667a466',  # sync good
    'ecb5520d-1358-434c-95ec-93687ecd1396',  # sync ok (off by one)
    '4b00df29-3769-43be-bb40-128b1cba6d35',  # sync good
    '54238fd6-d2d0-4408-b1a9-d19d24fd29ce',  # sync ok (off by one?)
    'db4df448-e449-4a6f-a0e7-288711e7a75a',  # sync good; in pupil/paw labeled data
    'b03fbc44-3d8e-4a6c-8a50-5ea3498568e0',  # sync ok (off by one or two); not in BWM dataset
    'd23a44ef-1402-4ed7-97f5-47e9a7a504d9',  # sync good
]
